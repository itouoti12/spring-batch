...
@DatabaseSetup("classpath:itouoti/spring/batch/repository/sharedRepository/tutorialWHEREType1/payment_setUp_data.xlsx")
@ExpectedDatabase(value = "classpath:itouoti/spring/batch/repository/sharedRepository/tutorialWHEREType1/expected_data.xlsx",
                  assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED)
@Slf4j
/**
 * sharedRepository TutorialWHEREType1 Test
 * @author itouoti
 */
public class SharedRepositoryTutorialWHEREType1Test {
    ...
    public static void setUpBeforeTest() throws Exception {
        ...
        log.info("□TutorialWHEREType1 test is start");
    ...
    public static void creanUpAfterTest() throws Exception {
        // テスト後の後処理があれば記述
        log.info("□TutorialWHEREType1 test is end");
    }

    /**
     * SharedRepository.TutorialWHEREType1テスト </br>
     * x &lt= 2 , 7 &lt= x
     * @throws Exception DBUnitのxlsx読み込み例外
     */
    @Test
    public void TutorialWHEREType1外側対象テスト() throws Exception {
     ...
     */
    @Test
    public void TutorialWHEREType1内側対象テスト() throws Exception {
